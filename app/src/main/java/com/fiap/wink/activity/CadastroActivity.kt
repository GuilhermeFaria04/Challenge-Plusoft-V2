...
class CadastroActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.cadastrolayout) // Certifique-se de que o nome do layout está correto

        // Verifique se os IDs estão corretos no XML
    ...
    private fun registerUser(cadastro: Cadastro) {
        val retrofit = Retrofit.Builder()
            .baseUrl("http://YOUR_SERVER_ADDRESS/") // Atualize o endereço do servidor
